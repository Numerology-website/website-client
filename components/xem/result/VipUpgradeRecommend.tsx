...
export const KidVipUpgradeRecommend = () => {
  return (
    <div className="flex flex-col justify-center rounded-xl bg-white p-2.5 text-center">
      <p className="mb-2 text-red-500">
        Gia đình đang sử dụng lượt tra miễn phí chỉ xem được giới hạn các luận
        giải. Để xem những luận giải và giải pháp mà các chuyên gia tại{" "}
        {process.env.NEXT_PUBLIC_DOMAIN} đã nghiên cứu cho toàn bộ chỉ số của
        bạn nhỏ và bố mẹ, vui lòng nâng cấp tài khoản VIP!
      </p>
      <div className="flex justify-center">
        <Link
          href="/purchase_kid"
